...
namespace Pumukit\Responsive\WebTVBundle\Services;
...
class BreadcrumbsService
{
    ...
    public function addSeries(Series $series)
    {
        ...
        $this->add($series->getTitle(), 'pumukit_responsive_webtv_series_index', array('id' => $series->getId()));
    }

    public function addMultimediaObject(MultimediaObject $multimediaObject)
    {
        $this->addSeries($multimediaObject->getSeries());
        $this->add($multimediaObject->getTitle(), 'pumukit_responsive_webtv_multimediaobject_index', array('id' => $multimediaObject->getId()));
    }
