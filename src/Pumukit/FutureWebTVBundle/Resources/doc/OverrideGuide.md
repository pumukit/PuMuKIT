...
class PumukitExampleOrgWebTVBundle extends Bundle
{
  ...
  {
    return 'PumukitFutureWebTVBundle';
  }
}
```
...
{% extends 'PumukitFutureWebTVBundle' %}
...
```html
<img src="{{ asset('bundles/pumukitfuturewebtv/images/webtv/logo80px.png') }}" class="img-responsive" style="max-height:100%" alt="{% trans %}Logo{% endtrans %}"/>
```
...
{% embed 'PumukitWebTVBundle:Layout:baseheader.html.twig' %}
  {% block logo_url %}
     <img src="{{ asset('bundles/pumukitfuturewebtv/images/logo.png') }}" class="img-responsive" alt="{% trans %}Logo{% endtrans %}"/>
  {% endblock %}
{% endembed %}
...
```yml
 parameters:
  ...
  pumukit_web_tv.default_pic: '/bundles/pumukitfuturewebtv/images/no_pic.jpg'
