...
class MoodleController extends Controller
{
  ...
  {
      $ticket  = $request->get('t');
      $culture = $request->get('lang');
      
      $this->setCultureIfPresent($culture);
      
      if ($professor = $this->findProfessorEmailTicket($ticket)){
  ...
  private function checkIdTicket($id, $ticket, $mail = false)
  {
  }
  ...
  private function findProfessorEmailTicket($ticket)
  {
  }
