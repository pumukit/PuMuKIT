    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
          ->children()
            ...
            ->end()
            ->booleanNode('show_ingestor_tab')
              ->defaultTrue()
              ->info('Opencast Ingestor Tab will be shown. If ingestion is done using batch import, set this parameter to false to hide the Opencast Ingestor Tab.')
            ->end()
