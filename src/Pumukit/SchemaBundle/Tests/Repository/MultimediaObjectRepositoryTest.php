...
class MultimediaObjectRepositoryTest extends WebTestCase
{
    ...
    public function testFindPersonWithRoleCodeAndEmail()
    {
        ...
        $person_ned = $this->createPerson('Ned');
        $person_ned = $this->setEmail('ned@email.com');
        $person_benjen = $this->createPerson('Benjen');
        $person_benjen = $this->setEmail('benjen@email.com');
        $person_mark = $this->createPerson('Mark');
        $person_mark = $this->setEmail('mark@email.com');
        ...
        $this->dm->flush();
        // TODO FINISH
        /* $peopleLord = $this->repo->findOnePersonWithRoleCodeAndEmail($role_lord->getCod()); */
        /* $this->assertEquals(3, count($peopleLord)); */
        /* $peopleRanger = $this->repo->findOnePersonWithRoleCodeAndEmail($role_ranger->getCod()); */
        /* $this->assertEquals(3, count($peopleRanger)); */
        /* $peopleHand = $this->repo->findOnePersonWithRoleCodeAndEmail($role_hand->getCod()); */
        /* $this->assertEquals(2, count($peopleHand)); */
    }
