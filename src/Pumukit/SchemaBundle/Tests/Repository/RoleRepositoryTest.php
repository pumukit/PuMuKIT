...
class RoleRepositoryTest extends PumukitTestCase
{
    ...
    public function testRank()
    {
        ...
        static::assertEquals(0, $role1->getRank());
        ...
        static::assertEquals(1, $role2->getRank());
        ...
        static::assertEquals(2, $role3->getRank());
        static::assertEquals(3, $role4->getRank());
        ...
        static::assertEquals(0, $roleFirst->getRank());
        static::assertEquals(1, $role1->getRank());
        static::assertEquals(4, $role4->getRank());
        ...
        static::assertEquals(1, $role1->getRank());
        static::assertEquals(4, $role4->getRank());
        static::assertEquals(5, $roleLast->getRank());
        ...
        static::assertEquals(0, $roleFirst->getRank());
        static::assertEquals(3, $role4->getRank());
        static::assertEquals(4, $roleLast->getRank());
        static::assertEquals(5, $role1->getRank());
    }
