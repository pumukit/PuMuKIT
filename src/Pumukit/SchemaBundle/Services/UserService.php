...
class UserService
{
     ...
     */
    public function __construct(DocumentManager $documentManager, SecurityContext $securityContext, UserEventDispatcherService $dispatcher, $personalScopeDeleteOwners=false)
    {
