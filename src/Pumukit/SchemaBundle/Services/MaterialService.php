...
class MaterialService
{
    ...
    public function __construct(DocumentManager $documentManager, MaterialEventDispatcherService $dispatcher, string $targetPath, string $targetUrl, bool $forceDeleteOnDisk = true)
    {
