...
class WidgetController extends Controller implements WebTVController
{
    ...
    public function menuAction()
    {
        ...
        self::$menuResponse = $this->render('PumukitLegacyWebTVBundle:Widget:menu.html.twig', $params);
    ...
    {
        if ($this->container->hasParameter('pumukit_new_admin.advance_live_event') && $this->container->getParameter('pumukit_new_admin.advance_live_event')) {
    ...
    public function statsAction()
    {
        ...
        $counts = array(
            ...
            'mms' => $mmRepo->count(),
            'hours' => round($mmRepo->countDuration() / 3600, 2),
        );
    ...
    /**
     * @Template("PumukitLegacyWebTVBundle:Widget:upcomingliveevents.html.twig")
     */
