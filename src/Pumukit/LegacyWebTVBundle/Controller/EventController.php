...
class EventController extends Controller implements WebTVController
{
    ...
    /**
     * @Template("PumukitLegacyWebTVBundle:Event:livelist.html.twig")
     */
     ...
     * @Template("PumukitLegacyWebTVBundle:Event:nextsessionlist.html.twig")
     */
     ...
     * @Template("PumukitLegacyWebTVBundle:Event:twitter.html.twig")
     */
