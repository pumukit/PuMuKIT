...
class BootstrapExtension extends \Twig_Extension
{
    ...
    {
        return array(
            new \Twig_SimpleFunction('col_calculator', array($this, 'getCols')),
            new \Twig_SimpleFunction('add_clear_fix_md', array($this, 'getClearFixMediumDevices')),
            new \Twig_SimpleFunction('add_clear_fix_sm', array($this, 'getClearFixSmallDevices')),
        );
    }
