...
class Builder extends ContainerAware
{
    public function mainMenu(FactoryInterface $factory, array $options)
    {
        ...
        */
        ...
        //$ingester->addChild('Opencast Ingester', array('route' => 'pumukitnewadmin_ingester_index'));
        $ingester->addChild('Opencast Ingester', array('route' => 'pumukitopencast_mediapackage_index'));
