...
namespace App\UI\Backoffice\ContentManagement\Role\Event;

use Symfony\Contracts\EventDispatcher\Event;

final class RoleListActionsEvent extends Event
{
    public const NAME = 'role.list_actions';

    private array $actions = [];

    /**
     * Add a custom action button to the role list.
     *
